...
interface FilterPanelProps {
  priceRange: number[],
  handleSliderUpdate: (e: Event) => void,
  getProducts: (arg0: string) => void,
}
...
const FilterPanel = ({priceRange, handleSliderUpdate, getProducts}: FilterPanelProps) => (
      ...
      <Box sx={{
        ...
        <Box sx={{display: "flex", flexDirection: "column", margin: 0, padding: 0}}>
          ...
          <Typography sx={{
            ...
            padding: "0px 2px",
            borderRadius: "4px"
          }}>{centsToDollar(priceRange[0])}</Typography>
        </Box>
        <Box sx={{display: "flex", flexDirection: "column", margin: 0, padding: 0}}>
          ...
          <Typography sx={{
            ...
            padding: "0px 2px",
            borderRadius: "4px"
          }}>{centsToDollar(priceRange[1])}</Typography>
        </Box>
      </Box>
  ...
  const displayedProducts = useMemo(() => {
    ...
    switch (sortOrder) {
      ...
      case "Price low to high":
        ...
        break;
      case "A to Z":
        newArray = products.toSorted((a, b) => a.productName.localeCompare(b.productName));
        break;
      case "Z to A":
        newArray = products.toSorted((a, b) => b.productName.localeCompare(a.productName));
        break;
      default:
  ...
  return (
      <>
        ...
        <Box sx={{
          ...
          {/* Filter panel */}
          <FilterPanel priceRange={priceRange} handleSliderUpdate={(event: Event,
